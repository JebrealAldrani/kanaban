      ...
      <div className="flex justify-between">
        ...
        <div className="flex flex-col md:flex-row gap-3 text-[#020817] font-medium items-center justify-center ">
          <div className="p-1 bg-[#F1F5F9] rounded-xl flex gap-2 h-fit">
            <button className="bg-white flex gap-2 no-wrap items-center justify-center h-fit rounded-[6px] py-1 px-3 cursor-pointer">
              <LayoutDashboard width={16} height={16} />
              <span>كانبان</span>
            </button>
            <button className="flex gap-2 no-wrap items-center justify-center h-fit rounded-[6px] py-1 px-3 hover:bg-[white] cursor-pointer">
